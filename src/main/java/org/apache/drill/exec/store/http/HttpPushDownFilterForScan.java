...
public class HttpPushDownFilterForScan extends StoragePluginOptimizerRule {
  ...
  private HttpPushDownFilterForScan() {
    super(RelOptHelper.some(FilterPrel.class, RelOptHelper.any(ScanPrel.class)), "HttpPushDownFilterForScan");
  }
  ...
  public void onMatch(RelOptRuleCall call) {
    ...
    newGroupsScan = new HttpGroupScan(groupScan.getUserName(), groupScan.getStoragePlugin(), newScanSpec, groupScan.getColumns());
    ...
    ScanPrel newScanPrel = ScanPrel.create(scan, filter.getTraitSet(),
